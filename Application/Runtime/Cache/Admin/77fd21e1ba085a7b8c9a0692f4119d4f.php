...
<form id="form1" name="form1" method="post" action="/index.php/admin/<?php echo ($module); ?>/ic_b_edit">
...
<div style="height: 20px;width: 10px;">
 ...
 <input id="img_url" name="img_url" value="<?php echo ($img_url); ?>" type="hidden">
...
<input type="text" id="titles" name="titles" value="<?php echo ($titles); ?>" placeholder="在这里写入标题" width="80%" style="width: 700px;"><span id="name_tips" class="bg-danger text-danger mx_tips"></span>
<div style="height: 20px;width: 10px;">
