...
<body class="gray-bg">
<form method="post" class="form-horizontal" id="form1" name="form1" action="/index.php/home/customer/add_customer">
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>客户新增 <small>请认真填写各项内容</small></h5>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-md-2">
                                        <input type="text" name="realname" placeholder="姓名" class="form-control" required="">
                                    </div>
                                    <div class="col-md-3">
                                        <input type="text" name="tel" placeholder="手机号码" class="form-control" required="">
                                    </div>
                                    <div class="col-md-4">
                        ...
                        <div class="hr-line-dashed"></div>
                         <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" placeholder="身份证号码" class="form-control" required="" name="pincode">
                                        </div>
                                    </div>
                        <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="身份证地址" class="form-control" required="" name="address">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="现住址" required="" name="now_address" class="form-control"> <span class="help-block m-b-none"></span>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">驾照信息</label>

                                        <div class="col-sm-10">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <input type="text" name="driver_code" placeholder="驾驶证号码" class="form-control" required="">
                                                </div>
                                                <div class="col-md-2">
                                                               <select class="form-control m-b" name="driver_type" required="">
                                                            ...
                                                            <div class="col-md-3">
                                                                            <input type="text" placeholder="驾驶证颁发机关" class="form-control" required="" name="driver_license">
                                                            </div>
                                            </div>
                                        </div>
                                    </div>
