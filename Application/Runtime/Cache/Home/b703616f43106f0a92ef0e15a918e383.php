    ...
    <div class="middleRight">
        <h5>
            <ul>
                <li>当前位置：</li>
                <li><a href="##">首页 &gt;</a></li>
                <li><a class="navActive"><?php echo ($name); ?></a></li>
            </ul>
        </h5>
        <ul>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="/index.php/home/index/show?id=<?php echo ($vo["id"]); ?>"><span class="spanTitle"><?php echo ($vo["titles"]); ?></span><span class="spanDate"><?php echo (date("Y-m-d $addtime")); ?></span></a><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
