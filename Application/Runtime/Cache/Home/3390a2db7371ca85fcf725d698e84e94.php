...
<head>
    ...
    <style type="text/css">
.layui-layer-title{background-color: #676a6c;}
    </style>
</head>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="ibox-content" >
                    ...
                    <button class="btn btn-primary dim btn-large-dim" style="width:230px" type="button">新建客户
                    </button>
                    <button class="btn btn-warning dim btn-large-dim" style="width:230px" type="button" value="car" onclick="open_frame_personal();">个人租车
                    </button>
                     <button class="btn btn-warning dim btn-large-dim" style="width:230px" type="button" value="car" onclick="open_frame_company();">企业租车
                    </button>
                    <button class="btn btn-danger  dim btn-large-dim" style="width:230px" type="button">订单列表
                    </button>
                    <button class="btn btn-primary  dim btn-large-dim" style="width:230px" type="button"><i class="fa fa-dollar"></i>车辆维保</button>
    ...
    <script>
        ...
        function open_frame_personal(){
            layer.open({
              ...
              content: ['/index.php/home/order/order_add', 'no']
            });
        ...
        function open_frame_company(){
            layer.open({
              ...
              area: ['1260px', '700px'],
              //skin: 'layui-layer-rim', //加上边框
              content: ['/index.php/home/order/order_add?type=c', 'no']
            });
